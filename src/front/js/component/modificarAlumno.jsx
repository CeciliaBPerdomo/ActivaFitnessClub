...
export const ModificarAlumno = () => {
    ...
    const modificarAlumno = (e) => {
        ...
        actions.modificarAlumno(id, ci, name, last_name, phone, admission, birthday, mutualist, conditions, medicines, training_goals, mail, password, activities, role, isActive);
    };
            ...
            <div className="formulario"
                ...
                <form>
                    ...
                    <div className="container text-start"
                        ...
                        <div className="row">
                            <div className="col"> {/* Fecha de nacimiento */}
                    ...
                    <div className="container text-start"
                        ...
                        <div className="row"> {/* Afecciones medicas */}
                            <div className="col">
                                ...
                                <input type="text" className="form-control" id="inputAfecciones"
                                    ...
                                    defaultValue={
                                        store.alumno.medical_conditions
                                    }/>
                            </div>
                            {/* Medicamentos */}
                            <div className="col">
                                ...
                                <input type="text" className="form-control" id="inputMedicamentos"
                                    onChange={
                                        (e) => setMedicines(e.target.value)
                                    }
                                    defaultValue={
                                        store.alumno.medicines
                                    }/>
                            </div>
                            ...
                            <div className="col">
                                ...
                                <input type="text" className="form-control" id="inputEntrenamiento" aria-describedby="emailHelp"
                                    onChange={
                                        (e) => setTraining(e.target.value)
                                    }
                                    defaultValue={
                                        store.alumno.training_goals
                                    }/>
                            </div>
                        </div>
                    </div>
