...
export const ModificarAlumno = () => {
    ...
    const modificarAlumno = (e) => {
        ...
        swal({
            ...
            actions: actions.modificarAlumno(id, ci, name, last_name, phone, admission, birthday, mutualist, conditions, medicines, training_goals, mail, password, activities, role, isActive, cuota)
        });
    };
            ...
            <div className="container vh-100"
                ...
                <div className="formulario"
                    ...
                    <form>
                        ...
                        <br/> {/* Agregar */}
                        <div>
                            <button type="submit" className="btn btn-outline-danger border border-white w-100"
                                style={
                                    {
                                        marginBottom: "20px",
                                        color: "white",
