            ...
            <div className="container vh-100"
                ...
                <div>
                    <Link to={"/mensualidades"}>
                        <button type="button" className="btn btn-outline-danger float-end border border-white w-50"
                            style={
                                {
                                    marginBottom: "20px",
                                    color: "white",
                    ...
                    <form onSubmit={agregarMensualidad}>
                        ...
                        <div className="row"
                            ...
                            <div className="col">
                                ...
                                <input type="text" className="form-control" placeholder="No. de factura"
                                    onChange={
