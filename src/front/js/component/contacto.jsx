...
export const Contacto = () => {
  ...
  switch (parseInt(params.theid)) {
    case 1:
      direccion = "https://formspree.io/f/xkneylzp";
      break;
    case 2:
      direccion = "https://formspree.io/f/mjvzlqon";
      break;
    case 3:
      direccion = "https://formspree.io/f/xrgdjwyd";
      break;
    case 4:
      direccion = "https://formspree.io/f/mbjbwvze";
      break;
    default:
      break;
  }
        ...
        <form action={direccion} method="POST">
          ...
          >
            <div className="card " style={{ width: "100%" }}>
              <div className="card-header" style={{ background: "#641E16" }}>
