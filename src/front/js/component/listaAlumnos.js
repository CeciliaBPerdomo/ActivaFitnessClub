        ...
        <>
            <div className="container vh-100"
                ...
                <div className="crearAlumno">
                    <Link to={"/crearAlumno"}>
                        <button type="button" className="btn btn-danger border border-white w-50 float-end"
                            style={
                                {
                                    marginBottom: "18px",
                                    color: "white",
                    ...
                    <tbody className="align-middle text-center">
                        ...
                        store.alumnos.map((item, id) => (
                            <tr key={id}>
                                ...
                                <td> {" "}
                                    {/* Crear rutina */}
                                    <button type="button" className="btn btn-outline-dark border border-white"
                                        style={
                                            {color: "white"}
                                        }
                                        onClick={
                                            (e) => crearRutina(e, item)
                                    }>
