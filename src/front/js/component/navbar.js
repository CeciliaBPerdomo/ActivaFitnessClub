                ...
                <nav className="navbar navbar-dark bg-danger fixed-top">
                    ...
                    >
                      Rutinas de Clientes
                                    ...
                                    <li className="nav-item">
                                        <Link className="nav-link" aria-current="page" to="/crearAlumno">
                                    ...
                                    <li className="nav-item">
                                        <Link className="nav-link" aria-current="page" to="/crearEjercicio">
                                            Crear Ejercicio
                                        </Link>
                                    </li>

                                    <hr className="text-light"/> {/* <li className="nav-item">
                    <Link className="nav-link" to="/">
                      Caja
                    </Link>
                  </li> */}

                                    {/* <hr className="text-light" /> */} </ul>
                                <br/>
                            </div>
                        </div>
                    </div>
