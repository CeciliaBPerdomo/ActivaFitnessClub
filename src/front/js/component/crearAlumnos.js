...
const SignupSchema = Yup.object().shape({
  ...
  mutualista: Yup.string()
    .min(2, "Too Short!")
    .max(50, "Too Long!")
    .required("Required"),
  afeccionesMedicas: Yup.string()
    .min(2, "Too Short!")
    .max(50, "Too Long!")
    .required("Required"),
  medicamentos: Yup.string()
    ...
    .max(50, "Too Long!")
    .required("Required"),
  objetivoDeEntrenamiento: Yup.string()
    .min(2, "Too Short!")
    .max(50, "Too Long!")
    .required("Required"),
        ...
        <Formik
          ...
          onSubmit={(values, { resetForm }) => {
            actions.crearAlumno(
              ...
              values.apellido,
              values.celular,
              values.fechaDeIngreso,
              values.fechaDeNacimiento,
              values.mutualista,
              values.afeccionesMedicas,
              values.medicamentos,
              values.objetivoDeEntrenamiento,
              values.email,
              values.password,
              values.actividades,
              values.rol,
            ...
            <Form className="row g-3 needs-validation">
                ...
                <div className="row" style={{ color: "white" }}>
                  <div className="col">
                    ...
                    {errors.cedula && touched.cedula ? (
                      <div className="text-light">{errors.cedula}</div>
                    ) : null}{" "}
                  </div>
                  ...
                  <div className="col">
                    ...
                    {errors.nombre && touched.nombre ? (
                      <div className="text-light">{errors.nombre}</div>
                    ) : null}{" "}
                  </div>
                  ...
                  <div className="col">
                    ...
                    {errors.apellido && touched.apellido ? (
                      <div className="text-light">{errors.apellido}</div>
                    ) : null}{" "}
                  </div>
                  ...
                  <div className="col">
                    ...
                    {errors.celular && touched.celular ? (
                      <div className="text-light">{errors.celular}</div>
                    ) : null}{" "}
                  </div>
                </div>
              </div>
                ...
                <div className="row" style={{ color: "white" }}>
                  ...
                  <div className="col">
                    ...
                    {errors.fechaDeIngreso && touched.fechaDeIngreso ? (
                      <div className="text-light">{errors.fechaDeIngreso}</div>
                    ) : null}{" "}
                  </div>
                  ...
                  <div className="col">
                    ...
                    {errors.mutualista && touched.mutualista ? (
                      <div className="text-light">{errors.mutualista}</div>
                    ) : null}{" "}
                  </div>
                </div>
              </div>
                ...
                <div className="row" style={{ color: "white" }}>
                  ...
                  <div className="col">
                    ...
                    {errors.medicamentos && touched.medicamentos ? (
                      <div className="text-light">{errors.medicamentos}</div>
                    ) : null}{" "}
                  </div>
                  ...
                  <div className="col">
                    ...
                    <Field
                      type="text"
                      name="objetivoDeEntrenamiento"
                      className="form-control"
                      id="inputEntrenamiento"
                      aria-describedby="emailHelp"
                    />
                    {errors.objetivoDeEntrenamiento &&
                    touched.objetivoDeEntrenamiento ? (
                      <div className="text-light">
                        {errors.objetivoDeEntrenamiento}
                      </div>
                    ) : null}{" "}
              ...
              >
                <div className="row" style={{ color: "white" }}>
                  ...
                  <div className="col">
                    <label htmlFor="actividades" className="form-label">
                      ...
                      {errors.actividades && touched.actividades ? (
                        <div className="text-light">{errors.actividades}</div>
                      ) : null}{" "}
                    </label>
                  </div>
                  {/* Rol */}
                  <div className="col">
                    <label htmlFor="rol" className="form-label">
                      ...
                      {errors.rol && touched.rol ? (
                        <div className="text-light">{errors.rol}</div>
                      ) : null}{" "}
                    </label>
                  </div>
                  {/* Cuota */}
                  <div className="col">
                    ...
                    {errors.cuota && touched.cuota ? (
                      <div className="text-light">{errors.cuota}</div>
                    ) : null}{" "}
                  </div>
                ...
                {errors.activo && touched.activo ? (
                  <div className="text-light">{errors.activo}</div>
                ) : null}{" "}
              </div>
              <br /> {/* Agregar */}
              <div>
