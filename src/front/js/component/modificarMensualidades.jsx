...
export const EditarMensualidad = () => {
    ...
    const modificarMensualidad = (e) => {
        ...
        swal({
            ...
            actions: actions.modificarMensualidad(id, user_id, fechaPago, numeroFactura, monto, descripcion)
        });
        navegacion("/mensualidades");
    };
            ...
            <div className="container vh-100"
                ...
                <div>
                    <Link to={"/mensualidades"}>
                        <button type="button" className="btn btn-outline-danger w-50 float-end border border-white"
                            style={
                                {
                                    marginBottom: "20px",
                                    color: "white",
                        ...
                        <div className="row"
                            ...
                            <div className="col">
                                ...
                                <input type="date" className="form-control"
                                    ...
                                    defaultValue={
                                        store.mensualidad.payment_date
                                    }/>
                            </div>
                        </div>
                        ...
                        <div className="row"
                            ...
                            <div className="col">
                                ...
                                <input type="text" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"
                                    ...
                                    defaultValue={
                                        store.mensualidad.payment_amount
                                    }/>
                            </div>
