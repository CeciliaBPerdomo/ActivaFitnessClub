...
export const EditarEjercicio = () => {
    ...
    const modificarEjercicio = (event) => {
        ...
        swal({
            ...
            actions: actions.modificarEjercicio(id, nombreEjercicio, tipoEjercicio, descripcionEjercicio, imagen, video)
        });
    ...
    return (
        <>
            <div className="container text-light vh-100"
                style={
                    {
                        marginTop: "90px",
                        marginBottom: "20px"
