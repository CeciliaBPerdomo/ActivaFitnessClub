...
export const CrearProducto = () => {
    ...
    const agregarProducto = (event) => {
        ...
        swal({
            ...
            actions: actions.crearProducto(nombreProducto, stock, compra, imagen, venta)
        });
    ...
    return (
        <>
            ...
            <div className="container vh-100"
                ...
                <br/> {/* Boton listado de productos */}
                <div>
                    <Link to={"/ListadoProductos"}>
                        <button type="button " className="btn border border-white w-50 float-end border border-white"
                            style={
                                {
                                    marginBottom: "20px",
                                    color: "white",
                    ...
                    <form>
                        ...
                        <div className="row"
                            ...
                            <div className="col">
                                ...
                                <input type="text" placeholder="Stock" className="form-control"
                                    onChange={
                            ...
                            <div className="col">
                                ...
                                <input type="text" placeholder="Precio de compra" className="form-control"
                                    onChange={
                            ...
                            <div className="col">
                                ...
                                <input type="text" placeholder="Precio de venta" className="form-control" id="basic-url"
                                    onChange={
                        ...
                        <div className="row"
                            ...
                            <div className="col">
                                ...
                                <input type="text" placeholder="URL de la foto del producto" className="form-control" id="basic-url"
                                    onChange={
